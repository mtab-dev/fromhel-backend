...
let ClientController = class ClientController {
    ...
    async clientRegister(createClientDto) {
        const emailExists = await this.clientService.checkEmail(createClientDto.email);
        if (emailExists) {
            throw new common_1.ConflictException('Email are already exists');
        }
...
__decorate([
    ...
    (0, swagger_1.ApiTags)('Register Methods'),
...
], ClientController.prototype, "clientRegister", null);
__decorate([
    (0, common_1.Get)('list'),
    (0, swagger_1.ApiTags)('List Methods'),
    (0, swagger_1.ApiBody)({ type: create_client_dto_1.CreateClientDto }),
    (0, swagger_1.ApiResponse)({
        status: 200,
...
__decorate([
    (0, common_1.Get)('listEmail/:email'),
    (0, swagger_1.ApiTags)('List Methods'),
    (0, swagger_1.ApiBody)({ type: create_client_dto_1.CreateClientDto }),
    (0, swagger_1.ApiResponse)({
        status: 200,
    ...
    __metadata("design:returntype", void 0)
], ClientController.prototype, "clientListOne", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ClientController.prototype, "clientListId", null);
__decorate([
    (0, common_1.Delete)('delete/:id'),
    (0, swagger_1.ApiTags)('Delete Methods'),
    (0, swagger_1.ApiBody)({ type: create_client_dto_1.CreateClientDto }),
    (0, swagger_1.ApiResponse)({
        status: 200,
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ClientController.prototype, "clientDelete", null);
